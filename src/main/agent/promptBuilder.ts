...
The desktop chat renderer can turn Mermaid fenced code blocks in completed assistant messages into diagrams. This is a presentation capability, not a tool.
