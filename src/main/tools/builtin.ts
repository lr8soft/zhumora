...
export const setTitleTool: ToolHandler = {
  definition: {
    ...
    function: {
      name: 'set_title',
      description: 'Set a short title (max 6 words) for the current conversation. When the system prompt contains a "Session Title" section, this is a required first action: call it in the same batch as your first work tool call. Never just mention the title in your reply text — that does not set it.',
      parameters: {
        type: 'object',
