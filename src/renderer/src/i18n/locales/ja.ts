...
export default {
  ...
  settings: {
    ...
    mcpServer: {
      ...
      token: 'アクセストークン',
      tokenPlaceholder: '有効化時に自動生成',
      tokenHint: 'MCP クライアントの設定に入力してください。空欄の場合、サーバー起動ごとに新しいトークンが生成されます。',
      autoTokenNote: 'トークンは自動生成のため保存されていません。アプリ再起動で変わるので、接続コマンドを再コピーしてください。',
      regenerate: '次回起動時にトークンを再生成',
      label: 'クライアント表示名',
      ...
      stateconnected: '稼働中',
      statefailed: '起動失敗',
      copyCommand: 'Claude Code の接続コマンドをコピー',
      copied: 'コピーしました'
    },
    skills: {
