...
export default {
  ...
  settings: {
    ...
    mcpServer: {
      ...
      tokenWaitHint: 'Le jeton n’existe qu’après enregistrement et démarrage du serveur. « Générer » en produit un fixe immédiatement.',
      generateToken: 'Générer',
      copyToken: 'Copier',
      autoTokenNote: 'Le jeton actuel a été généré automatiquement et n’est pas enregistré. Il change au redémarrage — recopiez-le. « Générer » écrit un jeton fixe.',
      ...
      jsonHint: 'Régénérez cette configuration à chaque changement de jeton ou de port.',
