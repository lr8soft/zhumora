...
export default {
  ...
  settings: {
    ...
    mcpServer: {
      ...
      token: 'Jeton d’accès',
      tokenPlaceholder: 'généré à l’activation',
      tokenHint: 'Collez-le dans la configuration de votre client MCP. S’il est vide, un nouveau jeton est généré à chaque démarrage du serveur.',
      autoTokenNote: 'Le jeton a été généré automatiquement et n’est pas enregistré. Il change au redémarrage — recopiez la commande de connexion.',
      regenerate: 'Régénérer le jeton au prochain démarrage',
      ...
      statefailed: 'Échec',
      copyCommand: 'Copier la commande Claude Code',
      copied: 'Copié'
    },
    skills: {
