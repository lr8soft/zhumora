...
export default {
  ...
  settings: {
    ...
    avatar: {
      ...
      addEmbedded: 'Clip hinzufügen', importVrma: '.vrma importieren (mehrere)', embedded: 'Eingebettet', animationName: 'Animationsname für LLM', clipName: 'Eingebetteter Clipname', newAnimation: 'Neue Animation'
    },
    tts: {
