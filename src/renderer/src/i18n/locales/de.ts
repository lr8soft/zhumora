...
export default {
  ...
  settings: {
    ...
    mcpServer: {
      ...
      tokenWaitHint: 'Das Token wird erst erzeugt, wenn der Server gespeichert und gestartet ist. „Generieren“ liefert sofort ein festes Token.',
      generateToken: 'Generieren',
      copyToken: 'Kopieren',
      autoTokenNote: 'Das aktuelle Token wurde automatisch generiert und nicht gespeichert. Es ändert sich nach dem Neustart – kopiere es erneut. „Generieren“ schreibt ein festes Token.',
      ...
      jsonHint: 'Diese Konfiguration neu erzeugen, sobald sich Token oder Port ändern.',
