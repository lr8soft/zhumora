...
export default {
  ...
  settings: {
    ...
    mcpServer: {
      ...
      token: 'Zugriffstoken',
      tokenPlaceholder: 'wird bei Aktivierung generiert',
      tokenHint: 'In die MCP-Client-Konfiguration einfügen. Bei leerem Feld wird bei jedem Serverstart ein neues Token erzeugt.',
      autoTokenNote: 'Das Token wurde automatisch generiert und nicht gespeichert. Es ändert sich nach dem Neustart – kopiere die Verbindungskommando erneut.',
      regenerate: 'Token beim nächsten Start neu generieren',
      ...
      copyCommand: 'Claude-Code-Befehl kopieren',
      copied: 'Kopiert'
    },
    skills: {
