...
export default {
  ...
  settings: {
    ...
    scheduled: {
      hint: '让 Agent 按计划自动运行。定时任务在精确时刻触发；心跳会周期性检查，只在有需要注意的事项时通知你。',
      add: '+ 新建任务',
      new: '新建定时任务',
      empty: '还没有定时任务。新建一个让 Agent 自动运行。',
      name: '名称',
      ...
      prompt: '指令',
      promptPlaceholder: '让 Agent 做什么？例如：把日历和未读邮件汇总成晨间简报。',
      approveMode: '工具权限模式',
      catchUp: '补跑错过的运行',
      catchUpHint: '若到点时应用在睡眠/挂起，醒来后一小时内补跑一次。',
      create: '创建任务',
      delete: '删除',
      deleteConfirm: '删除该定时任务？其运行历史将被移除。',
      runNow: '立即运行',
      history: '运行历史',
      enable: '启用',
      disable: '停用',
      running: '运行中',
      autoDisabled: '已自动停用（连续失败）',
      noRuns: '暂无运行记录。',
      daily: '每天 {{time}}',
      weekly: '每周{{day}} {{time}}',
      every: '每 {{minutes}} 分钟',
