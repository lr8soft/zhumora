...
export default {
  ...
  settings: {
    ...
    mcpServer: {
      ...
      token: '访问令牌',
      tokenPlaceholder: '启用时自动生成',
      tokenHint: '把它填进 MCP 客户端配置。留空时每次启动服务器都会生成新令牌。',
      autoTokenNote: '令牌为自动生成，未写入设置；重启应用后令牌会变化，需重新复制接入命令。',
      regenerate: '下次启动时重新生成令牌',
      label: '客户端名称',
      ...
      stateconnected: '运行中',
      statefailed: '启动失败',
      copyCommand: '复制 Claude Code 接入命令',
      copied: '已复制'
    },
    skills: {
