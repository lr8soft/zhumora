...
export default {
  ...
  settings: {
    ...
    mcpServer: {
      ...
      tokenWaitHint: 'The token only exists after the server is saved and started; click "Generate" to get a fixed token immediately.',
      generateToken: 'Generate',
      copyToken: 'Copy',
      autoTokenNote: 'The current token is auto-generated and not saved. It changes on app restart — re-copy it. Click "Generate" to write a fixed token.',
      label: 'Client label',
      ...
      jsonHint: 'Regenerate this config whenever the token or port changes.',
