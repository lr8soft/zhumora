...
export default {
  ...
  settings: {
    ...
    mcpServer: {
      ...
      token: 'Access token',
      tokenPlaceholder: 'auto-generated when enabled',
      tokenHint: 'Paste it into your MCP client config. Left empty, a new token is generated on every server start.',
      autoTokenNote: 'The token was auto-generated and is not saved. It changes on app restart — re-copy the connection command.',
      regenerate: 'Regenerate token on next start',
      label: 'Client label',
      ...
      statefailed: 'Failed',
      copyCommand: 'Copy Claude Code command',
      copied: 'Copied'
    },
    skills: {
