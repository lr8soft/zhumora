...
export default {
  ...
  settings: {
    ...
    scheduled: {
      hint: 'Run the agent automatically on a schedule. Cron tasks fire at exact times; a heartbeat runs periodically and only notifies you when something needs attention.',
      add: '+ Add Task',
      new: 'New Scheduled Task',
      empty: 'No scheduled tasks yet. Create one to run the agent automatically.',
      name: 'Name',
      namePlaceholder: 'e.g. Morning briefing',
      type: 'Type',
      cron: 'Cron (exact time)',
      heartbeat: 'Heartbeat (periodic check)',
      when: 'Schedule',
      optDaily: 'Daily',
      optWeekly: 'Weekly',
      optInterval: 'Every N minutes',
      time: 'Time',
      weekday: 'Weekday',
      intervalMinutes: 'Interval (minutes)',
      prompt: 'Instruction',
      promptPlaceholder: 'What should the agent do? e.g. Summarize my calendar and unread emails into a morning briefing.',
      approveMode: 'Tool permission mode',
      catchUp: 'Catch up missed runs',
      catchUpHint: 'If the app was asleep/suspended at the scheduled time, run once within an hour of waking.',
      create: 'Create Task',
      delete: 'Delete',
      deleteConfirm: 'Delete this scheduled task? Its run history will be removed.',
      runNow: 'Run now',
      history: 'Run history',
      enable: 'Enable',
      disable: 'Disable',
      running: 'Running',
      autoDisabled: 'Auto-disabled (repeated failures)',
      noRuns: 'No runs yet.',
      daily: 'Daily at {{time}}',
