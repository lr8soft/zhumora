...
export default {
  ...
  settings: {
    ...
    mcpServer: {
      ...
      tokenPlaceholder: 'se genera al activar',
      tokenHint: 'Pégalo en la configuración de tu cliente MCP. Si se deja vacío, se genera un token nuevo en cada arranque del servidor.',
      autoTokenNote: 'El token se generó automáticamente y no se guarda. Cambia al reiniciar — vuelve a copiar el comando de conexión.',
      regenerate: 'Regenerar el token en el próximo arranque',
      ...
      statefailed: 'Fallo',
      copyCommand: 'Copiar comando de Claude Code',
      copied: 'Copiado'
    },
    skills: {
