...
export default {
  ...
  settings: {
    ...
    mcpServer: {
      ...
      tokenWaitHint: 'El token solo existe tras guardar e iniciar el servidor; «Generar» da uno fijo de inmediato.',
      generateToken: 'Generar',
      copyToken: 'Copiar',
      autoTokenNote: 'El token actual se generó automáticamente y no se guarda. Cambia al reiniciar — vuelve a copiarlo. «Generar» escribe un token fijo.',
      ...
      jsonHint: 'Vuelve a generar esta configuración si cambias el token o el puerto.',
